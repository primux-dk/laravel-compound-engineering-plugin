...
component: [eloquent_model|laravel_controller|blade_view|service_object|background_job|database|alpine_js|livewire|email_processing|brief_system|assistant|authentication|payments]
symptoms:
...
laravel_version: [11.0.0 - optional]
