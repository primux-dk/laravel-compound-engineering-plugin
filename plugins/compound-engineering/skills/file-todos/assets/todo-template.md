...
**Example format:**
- Identified 12 missing test scenarios in `tests/Feature/UserTest.php`
- Current coverage: 60% of code paths
- Missing: empty inputs, special characters, large payloads
- Similar issues exist in `tests/Feature/PostTest.php` (~8 scenarios)
...
**Affected files:**
- `app/Models/User.php:45` - fullName method
- `app/Services/UserService.php:12` - validation logic
- `tests/Feature/UserTest.php` - existing tests
